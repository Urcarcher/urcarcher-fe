    ...
    const openModal = (content) => {
        const modalContents = {
            serviceTOS: `
                ...
                <p>당사는 카드 발급 및 서비스 제공을 위해 귀하의 개인정보를 수집, 이용합니다. 수집된 개인정보는 관련 법령에 따라 안전하게 관리되며, 다음과 같은 목적으로 이용됩니다.</p>
                <h5>1. 수집 항목</h5>
                <ul>
                ...
                <p>귀하는 개인정보 수집 및 이용 동의를 거부할 권리가 있으며, 다만, 동의를 거부하실 경우 카드 발급 및 서비스 제공이 제한될 수 있습니다.</p>
            `,
            personalTOS: `
                <h4>고유식별 정보처리 동의</h4>
                <p>본인은 당사가 다음과 같은 목적으로 고유식별정보를 처리하는 것에 동의합니다.</p>
                <h5>1. 처리 항목</h5>
                <ul>
                ...
                <h5>4. 동의 거부 권리 및 불이익</h5>
                <p>귀하는 고유식별정보 처리에 대한 동의를 거부할 권리가 있으며, 거부 시 카드 발급 및 서비스 제공이 제한될 수 있습니다.</p>
            `,
            marketingTOS: `
                <h4>마케팅 정보 수신 동의</h4>
                <p>본인은 당사가 귀하에게 다양한 마케팅 정보를 제공하는 것에 동의합니다.</p>
                <h5>1. 수집 항목</h5>
                <ul>
                ...
                <h5>4. 동의 거부 권리 및 불이익</h5>
                <p>귀하는 마케팅 정보 수신에 대한 동의를 거부할 권리가 있으며, 동의를 거부하셔도 카드 발급 및 기본 서비스는 이용하실 수 있습니다.</p>
            `,
            thirdPartyTOS: `
                <h4>제3자 정보 제공 동의</h4>
                <p>본인은 당사가 제3자에게 개인정보를 제공하는 것에 동의합니다.</p>
                <h5>1. 제공 대상</h5>
                <ul>
                ...
                <h5>5. 동의 거부 권리 및 불이익</h5>
                <p>귀하는 제3자 정보 제공 동의를 거부할 권리가 있으며, 거부 시 일부 서비스 제공에 제한이 있을 수 있습니다.</p>
            `,
        };
